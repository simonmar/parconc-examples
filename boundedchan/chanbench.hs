...
import qualified TChan as MyTChan
import TQueue
import TBQueue
...
#elif defined(MYTCHAN)
newc = atomically $ MyTChan.newTChan
readc c = atomically $ MyTChan.readTChan c
writec c x = atomically $ MyTChan.writeTChan c x
#endif
